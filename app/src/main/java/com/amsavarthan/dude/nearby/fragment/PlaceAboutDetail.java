...
public class PlaceAboutDetail extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_place_about_detail, container, false);
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (mFavouriteImageIcon.getDrawable().getConstantState().equals(
                            ...
                            currentPlaceDetail.put(PlaceDetailContract.PlaceDetailEntry.COLUMN_PLACE_ID,
                                    mCurrentPlace.getPlaceId());
                            currentPlaceDetail.put(PlaceDetailContract.PlaceDetailEntry.COLUMN_PLACE_LATITUDE,
                                    mCurrentPlace.getPlaceLatitude());
                            currentPlaceDetail.put(PlaceDetailContract.PlaceDetailEntry.COLUMN_PLACE_LONGITUDE,
                                    mCurrentPlace.getPlaceLongitude());
                            currentPlaceDetail.put(PlaceDetailContract.PlaceDetailEntry.COLUMN_PLACE_NAME,
                                    mCurrentPlace.getPlaceName());
                            currentPlaceDetail.put(PlaceDetailContract.PlaceDetailEntry.COLUMN_PLACE_OPENING_HOUR_STATUS,
                                    mCurrentPlace.getPlaceOpeningHourStatus());
                            currentPlaceDetail.put(PlaceDetailContract.PlaceDetailEntry.COLUMN_PLACE_RATING,
                                    mCurrentPlace.getPlaceRating());
                            currentPlaceDetail.put(PlaceDetailContract.PlaceDetailEntry.COLUMN_PLACE_ADDRESS,
                                    mCurrentPlace.getPlaceAddress());
                            currentPlaceDetail.put(PlaceDetailContract.PlaceDetailEntry.COLUMN_PLACE_PHONE_NUMBER,
                                    mCurrentPlace.getPlacePhoneNumber());
                            currentPlaceDetail.put(PlaceDetailContract.PlaceDetailEntry.COLUMN_PLACE_WEBSITE,
                                    mCurrentPlace.getPlaceWebsite());
                            currentPlaceDetail.put(PlaceDetailContract.PlaceDetailEntry.COLUMN_PLACE_SHARE_LINK,
                                    mCurrentPlace.getPlaceShareLink());

                            //Insert Data into Database
                            getContext().getContentResolver().insert(PlaceDetailContract.PlaceDetailEntry.CONTENT_URI,
                                    currentPlaceDetail);
                            ...
                            Uri placeDetailUrl = PlaceDetailContract.PlaceDetailEntry.CONTENT_URI;
                            String selection = PlaceDetailContract.PlaceDetailEntry.COLUMN_PLACE_ID + "=?";
        ...
        if (placeDataCursor.moveToFirst()) {
            do {
                String id = placeDataCursor.getString(placeDataCursor.getColumnIndex(
                        PlaceDetailContract.PlaceDetailEntry.COLUMN_PLACE_ID));
