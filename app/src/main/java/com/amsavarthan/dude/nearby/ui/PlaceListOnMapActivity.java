...
import com.amsavarthan.dude.nearby.utils.AppController;
...
public class PlaceListOnMapActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLocationQueryStringUrl = GoogleApiUrl.BASE_URL + GoogleApiUrl.NEARBY_SEARCH_TAG + "/" +
                ...
                sharedpreferences.getString("radius",GoogleApiUrl.RADIUS_VALUE) + "&" + GoogleApiUrl.PLACE_TYPE_TAG + "=" + mLocationTag +
        ...
        ((TextView) findViewById(R.id.place_list_placeholder_text_view))
                .setText(getResources().getString(R.string.near_by_tag) + " " + mLocationName + " " + getString(R.string.list_tag));
